...
client.on("ready", () => {
  ...
  const registerObject = {
    clone: {
      name: "clone",
      description:
        "Clone the current channels messages to another server using a webhook",
      type: ApplicationCommandType.ChatInput,
      options: [
        {
          name: "webhook_url",
          description:
            "The webhook url to send the messages to (Don' worry the command with only be visible to you)",
          required: true,
